BFF - паттерн проектирования, когда фронт не ходит в разные сервисы с разными запросамаи, чтобы в дальнейшем собирать свой фронт из кусочков с разных серверов, а обращается к одному проксирующему бэку.
